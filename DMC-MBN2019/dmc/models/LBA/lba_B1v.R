# Template setup for n-choice LBA, B=b-A parameterization: v vs. (1-v) paramerization
# NB: mean_v.false parameter should be made a constant (so wont be sampled)
#     and set to -Inf (so can be identified and replaced). 
